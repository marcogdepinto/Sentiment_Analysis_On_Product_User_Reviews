...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun  4 13:33:51 2020
...
class Train:
    ...
    def model(self, embedding_matrix, vocab_size,
        ...
        #E' un problema di regressione e non di classificazione
        ...
        #RMS error is: 2.7990 !!! Molto Alto!
        #BEST baseline ON TRAINING SET 1.0334
